...
async def recommendations(adv: str = 'Y0W3K7OV6ZLILW96OO3K', Modelo: str ='TopProduct'):
  ...
  if Modelo=='TopProduct':
    #df_tp = pd.read_csv('/Users/matiasbergman/airflow/dags/TopProduct_final.csv')
    df_tp=df_tp[(df_tp['date']==hoy)]
    result_prod=df_tp[df_tp['advertiser_id']==adv]['product_id'].to_list()

  else:
    # df_ctr= pd.read_csv('/Users/matiasbergman/airflow/dags/TopCTR_final.csv')
...
async def history(adv: str = 'Y0W3K7OV6ZLILW96OO3K'):
  ...
  #df_tp = pd.read_csv('/Users/matiasbergman/airflow/dags/TopProduct_final_2.csv')
  df_tp['Model']='TopProduct'
  df_tp=df_tp[['date','Model','advertiser_id','product_id']]
   
  #df_ctr = pd.read_csv('/Users/matiasbergman/airflow/dags/TopCTR_final_2.csv')
  df_ctr['Model']='TopCTR'
